 ...
 *   3. This deletes: PT_Log, PT_LibDebug, PT_<TestName>
 *
 * Files preserved:
 ...
 *
 * NOTE: Does NOT delete 'out' - LaunchAPPLServer needs it to send results.
 *
...
static void test_cleanup_files(const char *test_log_name)
{
    ...
    /* NOTE: Do NOT delete "out" - LaunchAPPLServer needs it to send results */
