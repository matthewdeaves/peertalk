...
Execute the demo app remotely:
  ...
  docker compose -f docker/docker-compose.yml run --rm peertalk-dev \
    <LAUNCHAPPL_CLIENT_PATH> <machine-ip>:1984 Temp:<demo-app>.bin

(Use the LAUNCHAPPL_CLIENT_PATH from step 2 based on platform)

Example for performa6400 (Open Transport):
  docker compose -f docker/docker-compose.yml run --rm peertalk-dev \
    /opt/Retro68/LaunchAPPL/build-ppc/Client/LaunchAPPLClient \
    10.188.1.102:1984 Temp:Dialog.bin

You should see the app window appear on your Mac!

Demo Apps Deployed:
  - Dialog.bin    - Simple dialog window (7KB)
  - HelloWorld.bin - Classic greeting (if built)
  - Launcher.bin   - File launcher (if built)
```
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Next: Deploy PeerTalk
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

Once testing confirms LaunchAPPL works:
  /deploy <machine-id> <platform>  # Deploy PeerTalk builds
  /fetch-logs <machine-id>         # Retrieve PT_Log output
  /session next                    # Start implementing
