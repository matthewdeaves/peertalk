...
|--------|---------|------|---------------|
| classic-mac-hardware | FTP access to Classic Mac test machines for binary deployment and log retrieval. Supports passive mode FTP via RumpusFTP | [server.py](../.claude/mcp-servers/classic-mac-hardware/server.py) | [SETUP.md](../.claude/mcp-servers/classic-mac-hardware/SETUP.md) |
