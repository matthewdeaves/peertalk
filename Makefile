...
CORE_SRCS = src/core/pt_version.c src/core/pt_compat.c src/core/pt_init.c src/core/protocol.c src/core/peer.c src/core/queue.c src/core/send.c src/core/direct_buffer.c src/core/stream.c src/core/buffer_pool.c
